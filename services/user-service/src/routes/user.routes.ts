import { createUser, getAllUsers, getDmCandidates, getUser, getUsersByIds, searchUsers } from '@/controllers/user.controller';
import { createUserSchema, getUsersByIdsSchema, searchUsersQuerySchema, userIdParamsSchema } from '@/validation/user.schema';
...
userRoutes.post('/by-ids', validateRequest({ body: getUsersByIdsSchema }), asyncHandler(getUsersByIds));
